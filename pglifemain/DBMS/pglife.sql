...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2022 at 06:00 PM
...
--
-- Table structure for table `book_users_properties`
--

CREATE TABLE `book_users_properties` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `book_users_properties`
--

INSERT INTO `book_users_properties` (`id`, `user_id`, `property_id`) VALUES
(1, 1, 1),
(0, 5, 3),
(0, 5, 5),
(0, 7, 3),
...
(20, 1, 'TEST PROPERTY NAME 1', 'TEST ADDRESS 1', 'TEST DESCRIPTION 1', 'male', 2999, 1.0, 2.0, 3.0),
(21, 1, 'TEST PROPERTY NAME 1', 'TEST ADDRESS 1', 'TEST DESCRIPTION 1', 'male', 2999, 1.0, 2.0, 3.0),
(22, 1, 'TEST PROPERTY NAME 1', 'TEST ADDRESS 1', 'TEST DESCRIPTION 1', 'male', 2999, 1.0, 2.0, 3.0),
(23, 1, 'TEST PROPERTY NAME 1', 'TEST ADDRESS 1', 'TEST DESCRIPTION 1', 'male', 2999, 1.0, 2.0, 3.0),
(24, 1, 'TEST PROPERTY NAME 1', 'TEST ADDRESS 1', 'TEST DESCRIPTION 1', 'male', 2999, 1.0, 2.0, 3.0),
(25, 1, 'TEST PROPERTY NAME 1', 'TEST ADDRESS 1', 'TEST DESCRIPTION 1', 'male', 2999, 1.0, 2.0, 3.0),
(26, 1, 'TEST PRopertty 2', 'TEST PRopertty address', 'TEST PRopertty  Description', 'male', 3003, 3.0, 2.0, 3.0),
(27, 1, 'TEST PRopertty 3', 'TEST PRopertty address3', 'TEST PRopertty  Description3', 'male', 30033, 3.0, 2.0, 3.0),
(28, 1, 'TEST PRopertty 3', 'TEST PRopertty address3', 'TEST PRopertty  Description3', 'male', 30033, 3.0, 2.0, 3.0),
(30, 1, 'teadufakdhf', 'asdfadf', 'asdfadf', 'unisex', 4343, 4.0, 3.0, 3.0);
...
(5, 'soyebshaikh41@gmail.com', '075314aa1839d369e7c0cf7f91f124f84f7ad132', 'Shaikh Soyeb Nasirhosen', '9834826827', 'male', 'padmashiri vikhe patile college of arts commer and science'),
(6, 'tejas.ratnaparkhi10@gmail.com', '075314aa1839d369e7c0cf7f91f124f84f7ad132', 'ahksjdf', '1234567890', 'male', 'asdfghjk'),
(7, '1@gmail.com', '075314aa1839d369e7c0cf7f91f124f84f7ad132', 'asdfasdf', '1234567890', 'male', 'asdfas');
...
ALTER TABLE `properties_amenities`
  ...
  ADD CONSTRAINT `properties_amenities_ibfk_2` FOREIGN KEY (`amenity_id`) REFERENCES `amenities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
